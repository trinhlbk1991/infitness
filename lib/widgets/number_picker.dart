...
class NumberPicker extends StatefulWidget {
  ...
  /// Theme of the [NumberPicker] widget:
  ///
  ///
...
class _NumberPickerState extends State<NumberPicker>
          ...
          child: Stack(
            ...
            children: <Widget>[
              Positioned(
                ...
                child: IconButton(
                  icon: Icon(Icons.remove_rounded, size: 40, color: _theme.iconsColor),
                  onPressed: () =>
              ...
              Positioned(
                ...
                child: IconButton(
                  icon: Icon(Icons.add_rounded, size: 40, color: _theme.iconsColor),
                  onPressed: () =>
  ...
  void _changeValue({required bool adding, bool fromButtons = false}) async {
    ...
    if (adding && _value + widget.step <= widget.maxValue)
      setState(() => _value += widget.step);
    else if (!adding && _value - widget.step >= widget.minValue)
      setState(() => _value -= widget.step);
    else
